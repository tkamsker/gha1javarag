...
- Entry point for the cache control application client module
...
- size
Relationships:
- Provided by Apache Commons FileUpload
#### SqlMapClientDaoSupport
Fields:
- sqlMapClient
Relationships:
- Extends Spring's DAO support class
#### ArrayList
Fields:
- Generic collection
Relationships:
...
- Key-value pairs
Relationships:
- Used for report parameters or results
#### BiteUser
Fields:
- user details
Relationships:
...
#### AppStarter
Description: Client-side starter class that initializes application resources and settings
#### AdminStarter
Description: Client-side starter class that initializes admin interface resources and settings
#### MyCuCoStarter
...
#### IbatisServletImpl
Description: Handles database operations using iBatis SqlMap configurations
#### CreditTypeServletImpl
Description: Spring-enabled remote service servlet for credit type management
#### ReportingServletImpl
Description: Spring-enabled remote service servlet for generating and managing reports
#### TeamServletImpl
...
#### FileContentServlet
Description: Handles HTTP requests for file content serving
#### FileUtil
Description: Provides file handling utility methods
#### SystemMessagesGrid
